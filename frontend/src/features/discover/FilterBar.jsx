      ...
      <div className="max-w-screen-xl mx-auto px-5 sm:px-8 lg:px-12 py-3 space-y-3">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <div className="relative w-44 sm:w-52">
            ...
            <input
              ...
              className="w-full pl-8 pr-3 py-2 text-[13px] rounded-full bg-white border border-line
                         text-ink placeholder:text-ink-light focus:outline-none focus:border-ink/30"
            />
          </div>
          ...
          <select
            ...
            className="text-[13px] border border-line rounded-full px-3 py-2 bg-white
          ...
          <div className="hidden sm:flex items-center gap-1.5">
            <input
              ...
              className="w-[4.5rem] text-[13px] border border-line rounded-full px-3 py-2 bg-white
                         text-ink-mid focus:outline-none focus:border-ink/30"
            />
          ...
          <select
            ...
            className="hidden md:block text-[13px] border border-line rounded-full px-3 py-2 bg-white
                       text-ink-mid focus:outline-none focus:border-ink/30 cursor-pointer"
          >
        ...
        {filters.with_person && filters.personName && (
          <div className="flex items-center gap-2">
            <div className="flex items-center gap-1.5 text-[12px] bg-ink text-white px-3 py-1 rounded-full">
                ...
                <button
                  ...
                  className={`
                    ...
                    ${active
                      ...
                      : 'bg-white text-ink-mid border-line hover:border-ink/30 hover:text-ink'
                    }
                  `}
                >
                  {g.name}
